...
def divide(x,y,width,height):
    ...
    if width <= 80:
        ...
        if orientation == 'Horizontal':
            #print(height)
            randy = random.randrange(y,y+height+20,20)
            horizontalWalls(x,x+width,randy)
            removeWall(random.randrange(x,x+width+20,20),randy)
            divide(x,y,width,randy-y)
            divide(x,randy,width,y+height-randy)
        elif orientation == 'Vertical':
            randx = random.randrange(x,x+width+20,20)
            verticalWalls(y,y+height,randx)
            removeWall(randx,random.randrange(y,y+width+20,20))
