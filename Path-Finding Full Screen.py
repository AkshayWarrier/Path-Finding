...
win = pg.display.set_mode((1366,768),pg.FULLSCREEN)
...
loadBut = Button(0,720,271,50,(0,102,204),(255,255,255),'Load Walls')
saveBut = Button(274,720,271,50,(0,102,204),(255,255,255),'Save Walls')
clearGridBut = Button(548,720,271,50,(0,102,204),(255,255,255),'Clear Grid')
aStarBut = Button(821,720,271,50,(0,102,204),(255,255,255),'A*')
dijkstraBut = Button(1094,720,271,50,(0,102,204),(255,255,255),'Dijsktra')
algo = ''
...
while run:
    ...
    #displaying text
    if algo == '':
        text("Select A Algorithm",570,2)
    elif start == None:
            text("Choose A Starting Point",550,2)
    elif end == None:
            text("Choose A Ending Point",550,2)
    ...
    if placedWall == True:
        ...
        if initiate == False and down == True and closed == []:
            text("Create\Load Walls And Press The Down Arrow Key To Start",320,2)
        elif  initiate == False and down == True and closed != []:
            if foundDest:
                text("Destination Has Been Found",530,2)
            else:
                text("Destination Was Not Found",530,2)
        ...
        if opened != []:
            ...
            if foundDest == False:
                ...
                for node in successors:
                    ...
                    if 0<=node.x<1360 and 40<=node.y<760 and nodeIn(node,walls) == False:
